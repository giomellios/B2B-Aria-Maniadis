...
export default async function ProductDetailPage({
  ...
  return (
    <>
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center">
            ...
            <div className="space-y-3">
              ...
              <p className="text-muted-foreground">
                Sustainably sourced and environmentally conscious
              </p>
            </div>
            <div className="space-y-3">
              <div className="w-12 h-12 mx-auto bg-primary/10 rounded-full flex items-center justify-center">
        ...
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="shipping">
              ...
              <AccordionContent>
                We offer standard shipping (5-7 business days), express shipping (2-3 business
                days), and next-day delivery for select areas. Free standard shipping is available
                on orders over $50.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="returns">
              ...
              <AccordionContent>
                ...
                original packaging. Simply contact our support team to initiate a return and receive
            ...
            <AccordionItem value="tracking">
              ...
              <AccordionContent>
                ...
                also view your order status anytime by logging into your account and visiting the
            ...
            <AccordionItem value="international">
              ...
              <AccordionContent>
                ...
                delivery times vary by location. You can see the exact cost at checkout before
      ...
      {primaryCollection && (
        <RelatedProducts collectionSlug={primaryCollection.slug} currentProductId={product.id} />
      )}
    </>
  );
}
